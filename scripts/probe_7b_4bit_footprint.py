...
GPU-work runs ONLY as ``python scripts/probe_7b_4bit_footprint.py``: the
whole body sits under a __main__ guard (audit 2026-09-18), so importing or
collecting this module (test discovery, help tooling) imports torch and
NOTHING more -- no CUDA reset, no model load, no GPU allocation.
"""
import os
